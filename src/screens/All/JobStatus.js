...
const JobStatusScreen = ({ route, navigation }) => {
  ...
  //   // find("settings", id).then((notifSnap) => {
  //   //   if (notifSnap.exists()) {
  //   //     setAllowNotif(notifSnap.data().bookings);
  //   //   }
  //   // });
  ...
  //         "Booking was confirmed by customer",
  //         "JobStatus",
  //         {
  //           bookingId: user?.bookingId,
  //         }
  //       );
  //       Alert.alert("Status Updated", "Successfully marked as done");
  //     },
  //     (error) => {
      ...
      if (currentStatus == "Waiting for Confirmation" && !doneAt) {
        return (
          ...
          >
            ...
            >
              {/* <Icon name="wrong" size={24} color="#FFF" /> */}
          ...
          <View style={styles.statusTimeline}>
            <View style={styles.timelineItem}>
              ...
              {!doneAt && currentStatus == "Waiting for Confirmation" ? (
                <View>
                  {/* <View
                    style={[styles.timelineConnector, styles.activeConnector]}
                  /> */}
