...
const MoreServices = ({ navigation }) => {
  ...
  const handleServicePress = (service) => {
    switch (service.type) {
      case "aircon":
        navigation.navigate("AirconServices", { service });
        break;
      case "Car Repair":
        navigation.navigate("CarRepairServices", { service });
        break;
      case "carwash":
        navigation.navigate("CarWashServices", { service });
        break;
      case "phone":
        navigation.navigate("PhoneRepairServices", { service });
        break;
      case "cleaning":
        navigation.navigate("HouseKeepingServices", { service });
        break;
      case "electrical":
        navigation.navigate("ElectricalServices", { service });
        break;
      case "laundry":
        navigation.navigate("LaundryServices", { service });
        break;
      case "massage":
        navigation.navigate("MassageServices", { service });
        break;
      case "plumbing":
        navigation.navigate("PlumbingServices", { service });
        break;
      case "watch":
        navigation.navigate("WatchRepairServices", { service });
        break;
      default:
        navigation.navigate("CarRepairServices", { service });
        break;
